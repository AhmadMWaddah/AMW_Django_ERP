...
class Policy(models.Model):
    ...
    resource = models.CharField(max_length=100, help_text="Resource pattern (e.g., inventory.*, sales.order.*)")
    action = models.CharField(max_length=100, help_text="Action pattern (e.g., create, read, update, delete)")
    is_active = models.BooleanField(default=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class Role(models.Model):
    ...
    policies = models.ManyToManyField(Policy, related_name="roles", help_text="Policies granted by this role")
    description = models.TextField(blank=True)
    is_active = models.BooleanField(default=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)

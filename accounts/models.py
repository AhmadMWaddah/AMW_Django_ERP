...
class Employee(AbstractBaseUser, PermissionsMixin):
    ...
    email = models.EmailField(
        'Email Address',
        unique=True,
        help_text='Required. Email address used for login.'
    )
    first_name = models.CharField(
        'First Name',
        max_length=30,
        blank=True,
        help_text='Optional. First name of the employee.'
    )
    last_name = models.CharField(
        'Last Name',
        max_length=30,
        blank=True,
        help_text='Optional. Last name of the employee.'
    )
    ...
    is_active = models.BooleanField(
        'Active',
        default=True,
        help_text='Designates whether this employee account is active.'
    )
    is_staff = models.BooleanField(
        'Staff Status',
        default=False,
        help_text='Designates whether the employee can log into admin.'
    )
    ...
    date_joined = models.DateTimeField(
        ...
        help_text='Date/time when the employee account was created.'
    )
